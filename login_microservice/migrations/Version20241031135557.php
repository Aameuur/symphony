 ...
 */
final class Version20241031135557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination CHANGE description address LONGTEXT NOT NULL, CHANGE image_url contact_information VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination CHANGE address description LONGTEXT NOT NULL, CHANGE contact_information image_url VARCHAR(255) NOT NULL');
