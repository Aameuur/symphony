 ...
 */
final class Version20241005153024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_A09D1B423414710B ON task_record (agent_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A09D1B423414710B ON task_record');
    }
}
