 ...
 */
final class Version20241031120806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination DROP price');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE destination ADD price NUMERIC(10, 2) NOT NULL');
