 ...
 */
final class Version20241031162719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning ADD ref_id INT NOT NULL');
        $this->addSql('ALTER TABLE planning ADD CONSTRAINT FK_D499BFF63414710B FOREIGN KEY (agent_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE planning ADD CONSTRAINT FK_D499BFF621B741A9 FOREIGN KEY (ref_id) REFERENCES coli (id)');
        ...
        $this->addSql('CREATE INDEX IDX_D499BFF621B741A9 ON planning (ref_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning DROP FOREIGN KEY FK_D499BFF621B741A9');
        ...
        $this->addSql('DROP INDEX IDX_D499BFF621B741A9 ON planning');
        $this->addSql('ALTER TABLE planning DROP ref_id');
